...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('story_recit', 'reference', self.gf('django.db.models.fields.related.ForeignKey')(related_name='recit_reference', null=True, to=orm['story.Recit'], blank=True), keep_default=False)
    ...
    models = {
        ...
        'story.page': {
            ...
            'premier_recit': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'premier_recit'", 'to': "orm['story.Recit']"}),
